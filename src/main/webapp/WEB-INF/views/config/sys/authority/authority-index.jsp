...
<div class="tabbable tabbable-primary">
	...
	<div class="tab-content">
		<div class="tab-pane fade active in">
			<div class="row search-form-default">
				<div class="col-md-12">
					<form action="#" method="get" class="form-inline form-validation form-search-init"
						data-grid-search=".grid-config-sys-authority-index">
			...
			<div class="row">
				<div class="col-md-12">
					<table class="grid-config-sys-authority-index"></table>
				</div>
			</div>
		</div>
	</div>
</div>
<script src="${ctx}/resources/script/config/sys/authority/authority-index.js" />
