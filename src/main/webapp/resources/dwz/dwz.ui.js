...
function initUI(_box){
	...
	/*//自定应 table
	$("table.configTable", $p).jTable();
	$("table.configTable", $p).cssTable();
	*/
	// css tables
	...
	if ($.fn.xheditor) {
		$("textarea.editor", $p).each(function(){
			var $this = $(this);
			var op = {html5Upload:false, skin: 'vista',urlBase : $this.attr('urlBase'),urlType: $this.attr('urlType') ||'rel',tools: $this.attr("tools") || 'full'};
			var upAttrs = [
	...
	if ( $.fn.swfupload) {
	    $('.swfupload-control', $p).each(function(){
		var $this = $(this);
		$this.swfupload({});
	  });
	}
