			...
			return this.each(function(){
				...
				setTimeout(function(){
					...
					$("a", $this).click(function(event){
						...
						var sTarget = $li.attr("target");
						if (sTarget) {
						    var $tree = $li.parents(".tree:first").parent();
						    if ($("#"+sTarget, $tree).size() == 0) {
							$tree.prepend('<input id="'+sTarget+'" type="hidden" />');
						    }
						    $("#"+sTarget, $tree).val($li.attr("rel"));
						}
