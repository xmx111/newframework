...
var navTab = {
	...
	_loadUrlCallback: function($panel){
		...
		/***增加scrollbar定位**/
		var scrollbarEls = $panel.find('.scrollbar');
		if($.fn.mCustomScrollbar && scrollbarEls.length==1 && window._scrollbar){
		    scrollbarEls.mCustomScrollbar("scrollTo",Math.abs(window._scrollbar.top));
		    delete window._scrollbar;
		}
	},
