...
(function($){
	...
	$.extend($.fn, {
	    	comboxDisabled:function(){
	    	   var $this = $(this);
	    	   var op = $("option:first", $this);
	    	   $('a',$this).addClass('disabled');
	    	   $("select", $this).val(op.val()).trigger("refChange").trigger("change");
	    	},
	    	comboxRestore:function(){
	    	   var $this = $(this);
	    	   var op = $("option:first", $this);
	    	   $('a',$this).val(op.val()).text(op.text()).addClass('disabled');
	    	   $("select", $this).val(op.val()).trigger("refChange").trigger("change");
	    	},
	    	comboxEnabled:function(){
