...
public class QuickPayQuery{
	...
	public static void main(String[] aa){
		new QuickPayQuery().queryTrans("01", "201408051718234", "20140805171823");
	}
	...
	public String query(String transType, String orderNumber, String orderTime) {
		...
		String cmdreturn=quickPayUtils.doPostQueryCmd(QuickPayConf.queryUrl,new QuickPayUtils().createBackStr(valueVo, QuickPayConf.queryVo));
