...
public class QuickPayConf {
	...
	/* 后台交易测试环境 */
	private final static String UPOP_BSPAY_BASE_URL = "https://202.101.25.184/UpopWeb/api";
...
//	private final static String UPOP_BSPAY_BASE_URL = "https://www.epay.lxdns.com/UpopWeb/api/";
	...
	/* 查询交易测试环境 */
	private final static String UPOP_QUERY_BASE_URL = "https://202.101.25.184/UpopWeb/api/";
...
//	private final static String UPOP_QUERY_BASE_URL = "https://www.epay.lxdns.com/UpopWeb/api/";
	...
	// 商户代码
	public final static String merCode = "";

	// 商户名称
	public final static String merName = "";

    public final static String merFrontEndUrl = "http://www.xxx.com/orderproces/account/recharge/rechargeUnionFront.htm";

    public final static String merBackEndUrl = "http://www.xxx.com/orderproces/account/recharge/rechargeUnionBack.json";
